                        ...
                        <form id="createForm" method="POST" action="{{ route('purchaseorder.store') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" value="{{ $data[0]['email'] ?? '' }}" class="form-control "
                                        id="email" name="email">
                                    ...
                                    <input type="text" id="pembayaran"
                                        value="{{ $data[0]['term_of_payment'] ?? '' }}" class="form-control"
                                        name="payment_term">
                                    ...
                                    <textarea class="form-control " rows="5" id="notes" name="notes">{{ $data[0]['description'] ?? '' }}</textarea>
                                </div>
                            </div>
                            <div class="p-2">
