    ...
    <div id="main-content">
        <div class="page-heading">
                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="/piutang/pembayaran">Pembayaran Piutang</a>
                                </li>
            ...
            <section class="section">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('piutang.pembayaran.store') }}" method="POST" id="createForm">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select id="payment_type" class="form-select" name="payment_type" required>
                                        ...
                                        <option value="diskonpenjualan">Diskon Penjualan</option>
                                        <option value="piutang">Hutang</option>
                                    </select>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            const templates = {
                firstRow: () => `
                                    <tr class="invoice-row first-row" style="border-bottom: 2px solid #000;">
                                        ...
                                        <td>
                                            <input type="number" class="form-control amount-paid" name="items[0][amount_paid]"
                                                required>
                                        </td>
                                        <td>
            ...
            function fetchInvoices(callback, excludeSelected = true) {
                ...
                $.ajax({
                    url: `/piutang/pembayaran/getinvoice/${state.principalId}`,
                    type: "GET",
                    dataType: "json",
