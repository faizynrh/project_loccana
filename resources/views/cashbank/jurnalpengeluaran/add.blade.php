            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Tambah Jurnal Pengeluaran</h3>
                    </div>
                            ...
                            <table class="table mt-3">
                                <thead>
                                    <tr style="border-bottom: 3px solid #000;">
                                        <th>Cash Debit<span class="text-danger bg-light px-1">*</span></th>
                                        <th>Jumlah</th>
                                        <th>Keterangan</th>
                                        {{-- <th></th> --}}
                                    </tr>
                                ...
                                <tbody id="tableBody">
                                    <tr style="border-bottom: 2px solid #000;">
                                        ...
                                        <td>
                                            <input type="number" class="form-control jumlah" name="items[0][debit]"
