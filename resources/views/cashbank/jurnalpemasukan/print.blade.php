...
<head>
    <meta charset="UTF-8">
    <title>Slip Kas/Bank Masuk</title>
    <style>
        body {
...
<body>
    ...
    <table class="info-table">
        ...
        <tr>
            ...
            <td class="info-separator">:</td>
            <td>{{ $data->data[0]->coa_debit }}</td>
        </tr>
        <tr>
            <td class="info-label">Deskripsi</td>
            <td class="info-separator">:</td>
            <td>{{ $data->data[0]->description_debit }}</td>
        </tr>
    </table>
    ...
    <table class="payment-table">
        ...
        <tbody>
            @foreach ($data->data as $item)
                <tr>
                    <td>{{ $item->id_credit }}</td>
                    <td>{{ $item->coa_credit }}</td>
                    <td>{{ $item->description_credit }}</td>
            ...
            <tr class="total-row">
                ...
                <td class="amount">Rp.
                    {{ number_format($data->data[0]->debit, 2, ',', '.') }}</td>
            </tr>
            </tr>
        </tbody>
    </table>
