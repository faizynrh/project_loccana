    ...
    <div id="main-content">
        <div class="page-heading">
            ...
            <section class="section">
                ...
                <div class="card">
                    <form action="{{ route('jurnal_pemasukan.update', $data->data[0]->jurnal_parent_id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row mb-3">
                                        ...
                                        <select class="form-select" name="coa_debit" required>
                                            ...
                                            @foreach ($listcoa as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ $data->data[0]->coa_debit == $item->id ? 'selected' : '' }}>
                                            ...
                                            <td>
                                                <select class="form-select coa-select" name="items[0][coa_credit]" required>
                                                    ...
                                                    @foreach ($listcoa as $coa)
                                                        <option value="{{ $coa->id }}"
                                                            {{ $data->data[0]->coa_credit == $coa->id ? 'selected' : '' }}>
